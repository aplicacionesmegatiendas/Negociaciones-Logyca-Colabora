...
namespace NegociacionesLogycaColabora
{
	public partial class FrmAdicionItems : Form
	{
		...
		private void ObtenerDatosItem(string referencia)
		{
			...
			txt_descripcion_tec1.Text= Convert.ToString(info_item[2][12]);
			txt_descripcion_tec2.Text= Convert.ToString(info_item[2][13]);
			txt_descripcion_tec3.Text= Convert.ToString(info_item[2][14]);
