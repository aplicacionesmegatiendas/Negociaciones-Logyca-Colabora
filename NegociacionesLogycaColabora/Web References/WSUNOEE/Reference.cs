...
namespace NegociacionesLogycaColabora.WSUNOEE {
    ...
    public partial class WSUNOEE : System.Web.Services.Protocols.SoapHttpClientProtocol {
        ...
        /// <remarks/>
        public WSUNOEE() {
            this.Url = global::NegociacionesLogycaColabora.Properties.Settings.Default.NegociacionesLogycaColabora_WSUNOEE_WSUNOEE;
        ...
        public System.Data.DataSet ImportarXML(string pvstrDatos, ref int printTipoError) {
            object[] results = this.Invoke("ImportarXML", new object[] {
                        pvstrDatos,
                        printTipoError});
            printTipoError = ((int)(results[1]));
            return ((System.Data.DataSet)(results[0]));
        }
        
        /// <remarks/>
        public void ImportarXMLAsync(string pvstrDatos, int printTipoError) {
            this.ImportarXMLAsync(pvstrDatos, printTipoError, null);
        }
        
        /// <remarks/>
        public void ImportarXMLAsync(string pvstrDatos, int printTipoError, object userState) {
